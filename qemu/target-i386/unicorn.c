            ...
            switch(regid) {
                ...
                case UC_X86_REG_IP:
                    *(int16_t *)value = READ_WORD(X86_CPU(uc, mycpu)->env.eip);
                    break;
                case UC_X86_REG_CS:
                    *(int16_t *)value = (uint16_t)X86_CPU(uc, mycpu)->env.segs[R_CS].base;
                    break;
                case UC_X86_REG_DS:
                    *(int16_t *)value = (uint16_t)X86_CPU(uc, mycpu)->env.segs[R_DS].base;
                    break;
                case UC_X86_REG_SS:
                    *(int16_t *)value = (uint16_t)X86_CPU(uc, mycpu)->env.segs[R_SS].base;
                    break;
                case UC_X86_REG_ES:
                    *(int16_t *)value = (uint16_t)X86_CPU(uc, mycpu)->env.segs[R_ES].base;
                    break;
                case UC_X86_REG_FS:
                    *(int16_t *)value = (uint16_t)X86_CPU(uc, mycpu)->env.segs[R_FS].base;
                    break;
                case UC_X86_REG_GS:
                    *(int16_t *)value = (uint16_t)X86_CPU(uc, mycpu)->env.segs[R_GS].base;
                    break;
