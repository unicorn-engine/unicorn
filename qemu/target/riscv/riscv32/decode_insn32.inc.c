...
typedef arg_decode_insn3213 arg_zext_h_32;
...
static bool decode_insn32(DisasContext *ctx, uint32_t insn)
{
    ...
    case 0x00000013:
        ...
        case 0x1:
            ...
            case 0x08001000:
                ...
                switch ((insn >> 20) & 0x3f) {
                case 0xf:
                    if (trans_zip(ctx, &u.f_decode_insn3213)) return true;
                    return false;
                }
                return false;
            case 0x60001000:
        ...
        case 0x5:
            ...
            case 0x08005000:
                ...
                switch ((insn >> 20) & 0x3f) {
                case 0xf:
                    if (trans_unzip(ctx, &u.f_decode_insn3213)) return true;
                    return false;
                }
                return false;
            case 0x28005000:
            ...
            case 0x68005000:
                ...
                case 0x7:
                    ...
                    return false;
                case 0x18:
                    if (trans_rev8_32(ctx, &u.f_decode_insn3213)) return true;
                    return false;
                }
                return false;
            }
    ...
    case 0x00000033:
        ...
        case 0x08004000:
            decode_insn32_extract_r2(ctx, &u.f_decode_insn3213, insn);
            if (((insn >> 20) & 0x1f) == 0 &&
                trans_zext_h_32(ctx, &u.f_decode_insn3213)) {
                return true;
            }
