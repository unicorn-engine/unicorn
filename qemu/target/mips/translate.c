    ...
    case OPC_MADD:
        {
            ...
            gen_move_low32(tcg_ctx, cpu_LO[acc], t2);
            gen_move_high32(tcg_ctx, cpu_HI[acc], t2);
                                          ...
                                          int rt, int rs)
{
    ...
    case NM_ABSQ_S_QB:
        ...
        gen_store_gpr(tcg_ctx, v0_t, ret);
        break;
    case NM_ABSQ_S_PH:
        check_dsp(ctx);
                                       ...
                                       int rd, int rs, int rt)
{
    ...
    case NM_CMPGU_EQ_QB:
        ...
        gen_store_gpr(tcg_ctx, v1_t, ret);
        break;
    case NM_CMPGU_LT_QB:
        check_dsp(ctx);
                    ...
                    while (counter != count) {
                        ...
                        case NM_LWM:
                            tcg_gen_qemu_ld_tl(ctx->uc, t1, va, ctx->mem_idx,
                                               memop | MO_TESL);
                            gen_store_gpr(tcg_ctx, t1, this_rt);
                            if ((this_rt == rs) &&
                                (counter != (count - 1))) {
                                /* UNPREDICTABLE */
                            }
