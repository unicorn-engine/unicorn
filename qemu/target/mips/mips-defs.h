...
#define INSN_LOONGSON3A   0x0020000000000000ULL
/*
 *   bits 56-63: vendor-specific ASEs
 */
#define ASE_MMI           0x0100000000000000ULL
#define ASE_MXU           0x0200000000000000ULL
#define ASE_LMMI          0x0400000000000000ULL
#define ASE_LEXT          0x0800000000000000ULL
...
#define CPU_LOONGSON3A  (CPU_MIPS64R2 | INSN_LOONGSON3A | ASE_LMMI | \
                         ASE_LEXT)
