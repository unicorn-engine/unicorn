...
GEN_HANDLER_E(lxvpx, 0x1F, 0x0D, 0x0A, 0, PPC_NONE, PPC2_ISA310),
GEN_HANDLER_E(lxvrbx, 0x1F, 0x0D, 0x00, 0, PPC_NONE, PPC2_ISA310),
GEN_HANDLER_E(lxvrhx, 0x1F, 0x0D, 0x01, 0, PPC_NONE, PPC2_ISA310),
GEN_HANDLER_E(lxvrwx, 0x1F, 0x0D, 0x02, 0, PPC_NONE, PPC2_ISA310),
GEN_HANDLER_E(lxvrdx, 0x1F, 0x0D, 0x03, 0, PPC_NONE, PPC2_ISA310),
...
GEN_HANDLER_E(stxvpx, 0x1F, 0x0D, 0x0E, 0, PPC_NONE, PPC2_ISA310),
GEN_HANDLER_E(stxvrbx, 0x1F, 0x0D, 0x04, 0, PPC_NONE, PPC2_ISA310),
GEN_HANDLER_E(stxvrhx, 0x1F, 0x0D, 0x05, 0, PPC_NONE, PPC2_ISA310),
GEN_HANDLER_E(stxvrwx, 0x1F, 0x0D, 0x06, 0, PPC_NONE, PPC2_ISA310),
GEN_HANDLER_E(stxvrdx, 0x1F, 0x0D, 0x07, 0, PPC_NONE, PPC2_ISA310),
#if defined(TARGET_PPC64)
...
#define GEN_VSX_XFORM_310(name, opc2, opc3, inval) \
GEN_HANDLER_E(name, 0x3F, opc2, opc3, inval, PPC_NONE, PPC2_ISA310)

#define GEN_VSX_XFORM_310_EO(name, opc2, opc3, opc4, inval)             \
GEN_HANDLER_E_2(name, 0x3F, opc2, opc3, opc4, inval, PPC_NONE, PPC2_ISA310)
...
GEN_VSX_XFORM_310_EO(XSCVQPUQZ, 0x04, 0x1A, 0x00, 0x00000001),
GEN_VSX_XFORM_310_EO(XSCVQPSQZ, 0x04, 0x1A, 0x08, 0x00000001),
GEN_VSX_XFORM_310_EO(XSCVUQQP, 0x04, 0x1A, 0x03, 0x00000001),
GEN_VSX_XFORM_310_EO(XSCVSQQP, 0x04, 0x1A, 0x0B, 0x00000001),
...
GEN_HANDLER_E(xxgenpcvbm, 0x3C, 0x14, 0x1C, 0, PPC_NONE, PPC2_ISA310),
GEN_HANDLER_E(xxgenpcvhm, 0x3C, 0x15, 0x1C, 0, PPC_NONE, PPC2_ISA310),
GEN_HANDLER_E(xxgenpcvwm, 0x3C, 0x14, 0x1D, 0, PPC_NONE, PPC2_ISA310),
GEN_HANDLER_E(xxgenpcvdm, 0x3C, 0x15, 0x1D, 0, PPC_NONE, PPC2_ISA310),
#endif
...
GEN_HANDLER2_E_2(xvtlsbb, "xvtlsbb", 0x3C, 0x16, 0x1D, 0x02,
                 0x00600001, PPC_NONE, PPC2_ISA310),
GEN_HANDLER2_E_2(xvtlsbb, "xvtlsbb", 0x3C, 0x17, 0x1D, 0x02,
                 0x00600001, PPC_NONE, PPC2_ISA310),
...
GEN_VSX_XFORM_310(XSCMPEQQP, 0x04, 0x02, 0x00000001),
GEN_VSX_XFORM_310(XSCMPGEQP, 0x04, 0x06, 0x00000001),
GEN_VSX_XFORM_310(XSCMPGTQP, 0x04, 0x07, 0x00000001),
...
GEN_VSX_XFORM_310(XSMAXCQP, 0x04, 0x15, 0x00000001),
GEN_VSX_XFORM_310(XSMINCQP, 0x04, 0x17, 0x00000001),
...
GEN_XX2FORM_EO(XVCVBF16SPN, 0x16, 0x1D, 0x10, PPC2_ISA310),
GEN_XX2FORM_EO(XVCVSPBF16, 0x16, 0x1D, 0x11, PPC2_ISA310),
