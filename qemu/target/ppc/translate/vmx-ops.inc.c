...
GEN_VXFORM_DUAL(vmrghb, vstri, 6, 0, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM(vmrghh, 6, 1),
GEN_VXFORM(vmrghw, 6, 2),
GEN_VXFORM(vmrglb, 6, 4),
GEN_VXFORM(vmrglh, 6, 5),
GEN_VXFORM_DUAL(vmrglw, vclrlb, 6, 6, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_310(vclrrb, 6, 7),
...
GEN_VXFORM_310(vmuloud, 4, 3),
GEN_VXFORM(vmulosb, 4, 4),
GEN_VXFORM(vmulosh, 4, 5),
GEN_VXFORM_207(vmulosw, 4, 6),
GEN_VXFORM_DUAL(vmulosd, vmulld, 4, 7, PPC_NONE, PPC2_ISA310),
GEN_VXFORM(vmuleub, 4, 8),
GEN_VXFORM(vmuleuh, 4, 9),
GEN_VXFORM_DUAL(vmuleuw, vmulhuw, 4, 10, PPC_NONE,
                PPC2_ALTIVEC_207 | PPC2_ISA310),
GEN_VXFORM_DUAL(vmuleud, vmulhud, 4, 11, PPC_NONE, PPC2_ISA310),
GEN_VXFORM(vmulesb, 4, 12),
GEN_VXFORM(vmulesh, 4, 13),
GEN_VXFORM_DUAL(vmulesw, vmulhsw, 4, 14, PPC_NONE,
                PPC2_ALTIVEC_207 | PPC2_ISA310),
GEN_VXFORM_DUAL(vmulesd, vmulhsd, 4, 15, PPC_NONE, PPC2_ISA310),
GEN_VXFORM_DUAL(vslb, vslq, 2, 4, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_DUAL(vslh, vrlqnm, 2, 5, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_DUAL(vslw, vrlwnm, 2, 6, PPC_ALTIVEC, PPC_NONE),
GEN_VXFORM_207(vsld, 2, 23),
GEN_VXFORM_DUAL(vsrb, vsrq, 2, 8, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM(vsrh, 2, 9),
GEN_VXFORM(vsrw, 2, 10),
GEN_VXFORM_207(vsrd, 2, 27),
GEN_VXFORM_DUAL(vsrab, vsraq, 2, 12, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM(vsrah, 2, 13),
GEN_VXFORM(vsraw, 2, 14),
GEN_VXFORM_207(vsrad, 2, 15),
GEN_VXFORM_300(vsrv, 2, 28),
GEN_VXFORM_300(vslv, 2, 29),
GEN_VXFORM_DUAL(vslo, vstri, 6, 16, PPC_ALTIVEC, PPC2_ISA310),
...
GEN_VXFORM_DUAL(vadduqm, vcmpuq, 0, 4, PPC_NONE,
                PPC2_ALTIVEC_207 | PPC2_ISA310),
GEN_VXFORM_DUAL(vaddcuq, vcmpsq, 0, 5, PPC_NONE,
                PPC2_ALTIVEC_207 | PPC2_ISA310),
GEN_VXFORM_DUAL(vaddeuqm, vaddecuq, 30, 0xFF, PPC_NONE, PPC2_ALTIVEC_207),
GEN_VXFORM_DUAL(vsubuqm, bcdtrunc, 0, 20, PPC2_ALTIVEC_207, PPC2_ISA300),
GEN_VXFORM_DUAL(vsubcuq, bcdutrunc, 0, 21, PPC2_ALTIVEC_207, PPC2_ISA300),
GEN_VXFORM_DUAL(vsubeuqm, vsubecuq, 31, 0xFF, PPC_NONE, PPC2_ALTIVEC_207),
GEN_VXFORM_DUAL(vrlb, vrlq, 2, 0, PPC_ALTIVEC, PPC2_ISA310),
...
GEN_VXFORM(vsr, 2, 11),
GEN_VXFORM_DUAL(vpkuhum, vinsbvlx, 7, 0, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_DUAL(vpkuwum, vinshvlx, 7, 1, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_207(vpkudum, 7, 17),
GEN_VXFORM_DUAL(vpkuhus, vinswvlx, 7, 2, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_DUAL(vpkuwus, vinsw, 7, 3, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_207(vpkudus, 7, 19),
GEN_VXFORM_DUAL(vpkshus, vinsbvrx, 7, 4, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_DUAL(vpkswus, vinshvrx, 7, 5, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_207(vpksdus, 7, 21),
GEN_VXFORM_DUAL(vpkshss, vinswvrx, 7, 6, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_DUAL(vpkswss, vinsd, 7, 7, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_207(vpksdss, 7, 23),
GEN_VXFORM_DUAL(vpkpx, vinsbrx, 7, 12, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_310(vinswrx, 7, 14),
GEN_VXFORM(vsum4ubs, 4, 24),
GEN_VXFORM(vsum4sbs, 4, 28),
GEN_VXFORM(vsum4shs, 4, 25),
GEN_VXFORM(vsum2sws, 4, 26),
GEN_VXFORM(vsumsws, 4, 30),
GEN_VXFORM_DUAL(vaddfp, vdivuq, 5, 0, PPC_ALTIVEC, PPC2_ISA310),
...
GEN_VXRFORM_DUAL(vcmpgtuw, vcmpgtuq, 3, 10, PPC_ALTIVEC, PPC2_ISA310)
GEN_VXRFORM_DUAL(vcmpeqfp, vcmpequd, 3, 3, PPC_ALTIVEC, PPC_NONE)
GEN_VXRFORM_DUAL(vcmpgefp, vcmpequq, 3, 7, PPC_ALTIVEC, PPC2_ISA310)
GEN_VXRFORM_DUAL(vcmpgtfp, vcmpgtud, 3, 11, PPC_ALTIVEC, PPC_NONE)
GEN_VXRFORM_DUAL(vcmpbfp, vcmpgtsd, 3, 15, PPC_ALTIVEC, PPC_NONE)
GEN_VXRFORM_DUAL(vcmpgtsw, vcmpgtsq, 3, 14, PPC_ALTIVEC, PPC2_ISA310)
...
GEN_HANDLER_E_2(vextsd2q, 0x04, 0x01, 0x18, 0x1B, 0, PPC_NONE,
                PPC2_ISA310),
...
GEN_VXFORM_DUAL(vupkhsb, vinsblx, 7, 8, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_DUAL(vupkhsh, vinshlx, 7, 9, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_207(vupkhsw, 7, 25),
GEN_VXFORM_DUAL(vupklsb, vinswlx, 7, 10, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_DUAL(vupklsh, vinsdlx, 7, 11, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_207(vupklsw, 7, 27),
GEN_VXFORM_DUAL(vupkhpx, vinshrx, 7, 13, PPC_ALTIVEC, PPC2_ISA310),
...
GEN_VXFORM_DUAL(vexptefp, vdivsw, 5, 6, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_DUAL(vlogefp, vdivsd, 5, 7, PPC_ALTIVEC, PPC2_ISA310),
...
#define GEN_VXFORM_UIMM(name, opc2, opc3)                               \
    GEN_HANDLER(name, 0x04, opc2, opc3, 0x00000000, PPC_ALTIVEC)
GEN_VXFORM_DUAL(vcfux, vdivesq, 5, 12, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_UIMM(vcfsx, 5, 13),
GEN_VXFORM_DUAL(vctuxs, vdivesw, 5, 14, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_DUAL(vctsxs, vdivesd, 5, 15, PPC_ALTIVEC, PPC2_ISA310),
GEN_VXFORM_310(vmoduq, 5, 24),
GEN_VXFORM_310(vmoduw, 5, 26),
GEN_VXFORM_310(vmodud, 5, 27),
GEN_VXFORM_310(vmodsq, 5, 28),
GEN_VXFORM_310(vmodsw, 5, 30),
GEN_VXFORM_310(vmodsd, 5, 31),
GEN_HANDLER_E(vgnb, 0x04, 6, 19, 0x00180000, PPC_NONE, PPC2_ISA310),
...
GEN_VXFORM_310(vclzdm, 0x02, 0x1E),
GEN_VXFORM_310(vctzdm, 0x02, 0x1F),
GEN_VXFORM_310(vpextd, 0x06, 0x16),
GEN_VXFORM_310(vmask_isa310, 0x01, 0x19),
GEN_HANDLER_E(vextdubv, 0x04, 0x0C, 0xFF, 0, PPC_NONE, PPC2_ISA310),
GEN_HANDLER_E(vextduhv, 0x04, 0x0D, 0xFF, 0, PPC_NONE, PPC2_ISA310),
GEN_HANDLER_E(vextduwv, 0x04, 0x0E, 0xFF, 0, PPC_NONE, PPC2_ISA310),
GEN_HANDLER_E(vextddv, 0x04, 0x0F, 0xFF, 0, PPC_NONE, PPC2_ISA310),
GEN_HANDLER_E(vsldbi_vsrdbi, 0x04, 0x0B, 0xFF, 0,
              PPC_NONE, PPC2_ISA310),
GEN_HANDLER_E(mtvsrbmi, 0x04, 0x0A, 0xFF, 0, PPC_NONE, PPC2_ISA310),
#endif

#if defined(TARGET_PPC64)
GEN_VXFORM_DUAL(vbpermd, vpdepd, 6, 23, PPC_NONE,
                PPC2_ISA300 | PPC2_ISA310),
GEN_VXFORM_DUAL(vbpermq, vcfuged, 6, 21, PPC_NONE,
                PPC2_ALTIVEC_207 | PPC2_ISA310),
#else
