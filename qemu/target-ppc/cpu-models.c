...
#define POWERPC_DEF_SVR(_name, _desc, _pvr, _svr, _type)                    \
    ...
    {                                                                       \
        ...
        dc->desc          = _desc;                                          \
                                                                            ...
                                                                            \
    void                                                             \
    glue(POWERPC_DEF_PREFIX(_pvr, _svr, _type), _cpu_register_types)(void *opaque);  \
    void                                                             \
    glue(POWERPC_DEF_PREFIX(_pvr, _svr, _type), _cpu_register_types)(void *opaque)  \
    {                                                                       \
    const TypeInfo                                                   \
...
{
//	cpu_ppc_init((struct uc_struct *)opaque, "mpc8544ds");
	ppc_e500v2_cpu_family_register_types((struct uc_struct *)opaque);
