...
class GdtRead(regress.RegressTest):
    ...
    def test_gdt(self):
        ...
        gdt_entry = create_gdt_entry(SEGMENT_ADDR, SEGMENT_SIZE, A_PRESENT | A_DATA | A_DATA_WRITABLE | A_PRIV_3 | A_DIR_CON_BIT, F_LONG)
        ...
        self.assertEqual(uc.reg_read(UC_X86_REG_RCX), 0x41414141)
