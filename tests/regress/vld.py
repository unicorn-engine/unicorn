...
class SIMDNotReadArm(regress.RegressTest):
    def runTest(self):
        ...
        self.assertEquals(mu.reg_read(UC_ARM_REG_D6), UC_ARM_REG_D6)
        self.assertEquals(mu.reg_read(UC_ARM_REG_D7), UC_ARM_REG_D7)
        ...
        self.assertEquals(mu.reg_read(UC_ARM_REG_D6), 0x0101010101010101)
        self.assertEquals(mu.reg_read(UC_ARM_REG_D7), 0x0101010101010101)
