...
typedef enum uc_avr_arch {
    ...
    UC_AVR_ARCH_AVR6 = 60,
    UC_AVR_ARCH_AVRXMEGA = 100,
    UC_AVR_ARCH_AVRXMEGAR2 = 101,
} uc_avr_arch;
...
typedef enum uc_cpu_avr {
    ...
    UC_CPU_AVR_ATXMEGA16A4 = UC_AVR_ARCH_AVRXMEGA*UC_CPU_AVR_ARCH + 16,
    UC_CPU_AVR_ATXMEGA32A4 = UC_AVR_ARCH_AVRXMEGA*UC_CPU_AVR_ARCH + 32,
    UC_CPU_AVR_ATXMEGA64A3 = UC_AVR_ARCH_AVRXMEGA*UC_CPU_AVR_ARCH + 64,
    UC_CPU_AVR_ATXMEGA64A1U = UC_AVR_ARCH_AVRXMEGAR2*UC_CPU_AVR_ARCH + 64,
    UC_CPU_AVR_ATXMEGA64A3U,
    UC_CPU_AVR_ATXMEGA64A4U,
    UC_CPU_AVR_ATXMEGA128A3 = UC_AVR_ARCH_AVRXMEGA*UC_CPU_AVR_ARCH + 128,
    UC_CPU_AVR_ATXMEGA128A1U = UC_AVR_ARCH_AVRXMEGAR2*UC_CPU_AVR_ARCH + 128,
    UC_CPU_AVR_ATXMEGA128A3U,
    UC_CPU_AVR_ATXMEGA128A4U,
    UC_CPU_AVR_ATXMEGA192A3 = UC_AVR_ARCH_AVRXMEGA*UC_CPU_AVR_ARCH + 192,
    UC_CPU_AVR_ATXMEGA192A3U = UC_AVR_ARCH_AVRXMEGAR2*UC_CPU_AVR_ARCH + 192,
    UC_CPU_AVR_ATXMEGA256A3 = UC_AVR_ARCH_AVRXMEGA*UC_CPU_AVR_ARCH + 256,
    UC_CPU_AVR_ATXMEGA256A3U = UC_AVR_ARCH_AVRXMEGAR2*UC_CPU_AVR_ARCH + 256,
} uc_cpu_avr;
