...
def __set_lib_prototypes(lib: ctypes.CDLL) -> None:
    ...
    # TODO:
    # __set_prototype('uc_context_reg_read2', uc_err, uc_context, ctypes.c_int, ctypes.c_void_p, ctypes.POINTER(ctypes.c_size_t))
    # __set_prototype('uc_context_reg_read_batch2', uc_err, uc_context, ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_void_p), ctypes.POINTER(ctypes.c_size_t), ctypes.c_int)
    # __set_prototype('uc_context_reg_write2', uc_err, uc_context, ctypes.c_int, ctypes.c_void_p, ctypes.POINTER(ctypes.c_size_t))
    # __set_prototype('uc_context_reg_write_batch2', uc_err, uc_context, ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_void_p), ctypes.POINTER(ctypes.c_size_t), ctypes.c_int)
    # __set_prototype('uc_reg_read2', uc_err, uc_engine, ctypes.c_int, ctypes.c_void_p, ctypes.POINTER(ctypes.c_size_t))
    # __set_prototype('uc_reg_read_batch2', uc_err, uc_engine, ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_void_p), ctypes.POINTER(ctypes.c_size_t), ctypes.c_int)
    # __set_prototype('uc_reg_write2', uc_err, uc_engine, ctypes.c_int, ctypes.c_void_p, ctypes.POINTER(ctypes.c_size_t))
    # __set_prototype('uc_reg_write_batch2', uc_err, uc_engine, ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_void_p), ctypes.POINTER(ctypes.c_size_t), ctypes.c_int)
